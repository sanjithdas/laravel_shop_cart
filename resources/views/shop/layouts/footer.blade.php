<div class="container-fluid bg-green-color">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                    <h4 class="subscribes-title">Email Newsletters!</h4>
                    <form class="subscribes-form " method="post" action="news/subscribe">@csrf
                       <div class="input-news"> 
                            <input style="width:60%" class=" email input-standard-grey input-white" name="email" required="required" placeholder="Your Email Address" type="email">
                            <button class="subcribes-btn">subscribe
            ...
            <div class="col-2">  
                ...
                <img src="{{asset('img/subscr-mailopen.png')}}" alt="mail" class="mt-10 mb-0 mail-2">
            </div>
        </div>    
    </div>                    
...
.subscribes .subscribes-form .subcribes-btn {
